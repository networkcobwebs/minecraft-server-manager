...
app.get('/', function(request, response) {
    // Return the version we are. Read in from package.json.
    response.contentType('json');
    response.json({
        version: "1.12.2"
    });
    // TODO Maybe load the React app here? Could that help the AJAX urls over there?
});
